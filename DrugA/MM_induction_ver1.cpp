...
dxdt_CYP3A4_ratio = kdeg_3a4 * (1 + Emax_3a4 * Cliverfree / (Cliverfree + EC50_3a4)) - (kdeg_3a4 + kinact_3a4 * Cliverfree / (KI_3a4 + Cliverfree)) * CYP3A4_ratio * (CYP3A4_ratio * enzyme_3a4 + Km_3a4) / (CYP3A4_ratio * enzyme_3a4 + Km_3a4 + Cliverfree / MW);
dxdt_CYP3A4_intestine_ratio = kdeg_3a4_intestine * (1 + Emax_3a4 * Cgutfree / (Cgutfree + EC50_3a4)) - (kdeg_3a4_intestine + kinact_3a4 * Cgutfree / (KI_3a4 + Cgutfree)) * CYP3A4_intestine_ratio* (CYP3A4_intestine_ratio * enzyme_3a4_intestine + Km_3a4) / (CYP3A4_intestine_ratio * enzyme_3a4_intestine + Km_3a4 + Cgutfree / MW);
